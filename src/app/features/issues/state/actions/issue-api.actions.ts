...
export const loadMeetingIssuesSuccess = createAction(
  '[Issue API] Load Meeting Issues Success',
  props<{ meetingIssues: Issue[] }>()
);

export const loadUpcomingIssuesSuccess = createAction(
  '[Issue API] Load Upcoming Issues Success',
  props<{ upcommingIssues: Issue[] }>()
);
