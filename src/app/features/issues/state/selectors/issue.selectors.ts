...
const getMeetingIssues = (state: fromIssueReducer.State) => state.meetingIssues;
const getUpcomingIssues = (state: fromIssueReducer.State) =>
  state.upcommingIssues;
...
export const getAllMeetingIssues = createSelector(
  fromSelectors.getIssueState,
  getMeetingIssues
);

export const getAllUpcomingIssues = createSelector(
  fromSelectors.getIssueState,
  getUpcomingIssues
);
...
export const getMeetingIssueById = createSelector(
  getAllMeetingIssues,
  (issues: Issue[], props: { issueId: string }) =>
    issues.find((i) => i.id === props.issueId)
);

export const getUpcomingIssuesById = createSelector(
