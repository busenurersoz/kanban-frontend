  ...
  static issues: Issue[] = [
    {
      ...
      description: {
        ops: [
          ...
          {
            attributes: { background: '#0047b2', color: '#ffffff' },
            insert: ' Create ',
          },
          { insert: ' button.' },
          { attributes: { list: 'bullet' }, insert: '\n' },
    ...
    },
    {
      id: '9210',
      title:
        'As an admin user, I want to be able to assign people to a project so that I can later assign these people to any issue',
      description: {
        ops: [
          {
            attributes: { bold: true },
            insert: 'Steps to assign people to a project:',
          },
          { attributes: { header: 3 }, insert: '\n' },
          { insert: 'Select the option ' },
          ...
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133827/assign-users-to-project.gif',
            },
          },
        ],
      },
      ...
      description: {
        ops: [
          ...
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133834/create-issue.gif',
            },
          },
        ],
      },
    ...
    },
    {
      id: '9451',
      title:
        'As an admin user, I want to be able to edit an issue so that I can later change the issue type, summary, description, status, priority, assigned users and reporter user',
      description: {
        ops: [
          {
            attributes: { bold: true },
            insert: 'An admin user can edit the following fields in an issue:',
          },
          { attributes: { header: 3 }, insert: '\n' },
          { insert: 'Type' },
          ...
          {
            attributes: { bold: true },
            insert: 'Demonstration of how to edit an issue',
          },
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133840/edit-issue.gif',
            },
          },
          { insert: '\n\n\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133846/assing-users-to-issue.gif',
            },
          },
        ],
      },
    ...
    },
    {
      id: '9584',
      title:
        'Filter issues by summary, by users and recently updated in the Kanban board',
      description: {
        ops: [
          {
            attributes: { bold: true },
            insert: 'Demonstration of how to filter issues',
          },
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133853/filter-issue.gif',
            },
          },
        ],
      },
    ...
    },
    {
      id: '9558',
      title:
        'As an admin user, I want to be able to manage projects so that I can switch between projects and see all the problems for each of them, as well as be able to edit or delete a project',
      description: {
        ops: [
          { attributes: { bold: true }, insert: 'Demo' },
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133863/manage-projects.gif',
            },
          },
        ],
      },
    ...
    },
    {
      id: '9631',
      title:
        'As an admin user, I want to be able to drag and drop an issue on the Kanban board so that I can change the issue status without showing the issue detail first',
      description: {
        ops: [
          { attributes: { bold: true }, insert: 'Demo' },
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133849/drag-drop-issue.gif',
            },
          },
        ],
      },
    ...
    },
    {
      id: '9628',
      title:
        'As a user, I want to be able to create, edit, and delete my own comments so that I can communicate with other users assigned to the same issue',
      description: {
        ops: [
          {
            attributes: { bold: true },
            insert:
              'Demonstration of how to create, edit, and delete a comment on an issue',
          },
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626135505/manage-comments.gif',
            },
          },
        ],
      },
      ...
      description: {
        ops: [
          ...
          { attributes: { header: 3 }, insert: '\n' },
          {
            insert: {
              image:
                'https://res.cloudinary.com/comparte/image/upload/v1626133858/delete-issue.gif',
            },
          },
        ],
      },
    ...
    },
    {
      ...
      description: {
        ops: [
          {
            attributes: { color: '#24292e' },
            insert: 'Currently this project use ',
          },
          {
            attributes: {
              color: '#0047b2',
              link: 'https://github.com/angular/angular/tree/master/packages/misc/angular-in-memory-web-api',
            },
            insert: 'angular-in-memory-web-api ',
          },
          {
            attributes: { color: '#24292e' },
            insert:
              'to emulates CRUD operations over a REST API, so the application data is stored in memory and every time the web is reloaded, the data will be restored. In the future, the backend will be implemented with ',
          },
